...
class TableClass {
    ...
    void brewJava() throws IOException {
        ...
        typeBuilder.addJavadoc("Generated By LightORM. DO NOT MODIFY");
        //添加静态变量
    ...
    private void addCollectFieldTypesMethod(TypeSpec.Builder builder) {
        ...
        MethodSpec.Builder collectFieldTypesMethod = MethodSpec.methodBuilder(METHOD_COLLECT_FIELD_TYPES)
                ...
                .addStatement("$L.put($S,$T.$L)", PARAM_NAME_VALUE, primaryKeyColumnName, BaseDao.FieldType.class, BaseDao.FieldType.INTEGER);
        for (ColumnField columnField : columnFieldMap.values()) {
